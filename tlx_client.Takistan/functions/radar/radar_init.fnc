...
Radar_blu addaction ["","noscript.sqf","['blu_radar_site']call radar_open;", 25, false, true, "LeanRight","dtk_cop && {!radar_inuse} && {player distance _target < 5} && {!([_target,'Open Radar (E)','data\images\items\radar.paa']call tag_show)}"];
ofor_radar addaction ["","noscript.sqf","['opf_radar_site']call radar_open;", 25, false, true, "LeanRight","dtk_opf && {!radar_inuse} && {player distance _target < 5} && {!([_target,'Open Radar (E)','data\images\items\radar.paa']call tag_show)}"];
