class Clothing
{
	...
	class ControlsBackground
	{
		...
		class RscBackground_Clothing : RscBackground 
		{
			idc = -1;
	...
	class Controls
	{
		...
		class Clothing_list : RscListBox 
		{
			idc = 150;
			x = safeZoneX + safeZoneW * 0.008125;
			y = safeZoneY + safeZoneH * 0.06888889;
			w = safeZoneW * 0.161875;
			h = safeZoneH * 0.74555556;
			colorDisabled[] = {0.2,0.2,0.2,1};
			colorSelectBackground[] = {0.5,0,0,0.5};
			onLBSelChanged = "[] call clothing_preview;";
