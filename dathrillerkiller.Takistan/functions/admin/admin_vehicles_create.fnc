...
if (!isNull admin_vehicle_current)then {
	deleteVehicle admin_vehicle_current;
};

admin_vehicle_current = [_item,screenToWorld[0.5,0.5],player,dtk_side]call shops_createVehicle;
