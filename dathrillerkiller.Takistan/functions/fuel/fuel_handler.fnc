...
while {((fuel _vehicle) < 0.99)} do 
{
	...
	[format['Fuel Status: %1 of 100. You refuelled 10 litres into your car. If you have enough',round(fuel _Vehicle * 100)],'data\images\tags\Gas pump',true]call tag_notify;
	
	sleep 1.5;
};

[format ["you have refueled the vehicle %1%",round(fuel _Vehicle * 100)],'data\images\tags\Gas pump',true]call tag_notify;
